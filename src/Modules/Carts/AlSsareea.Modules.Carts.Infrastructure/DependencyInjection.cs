...
public static class DependencyInjection
{
    public static IServiceCollection AddCartsInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        string? connection = configuration.GetConnectionString("CartsDatabase") ?? configuration.GetConnectionString("PromotionsDatabase");
        ...
        services.AddScoped<ICartRepository, CartRepository>(); services.AddScoped<ICartService, CartService>(); return services;
    }
}
